...
--
-- Host: localhost
-- Generation Time: Apr 08, 2019 at 01:32 AM
...
INSERT INTO `tbl_detail_order_customer` (`id_detail_order`, `kd_detail_order`, `menu_kd`, `qty`, `subtotal`) VALUES
(1, 'ODRD001040819', 'MENU001', 1, 20000);
...
(1, '201643502057', '3627e7e6b1136675a6b6b04f9c60323f', 'superadmin', 'n', '2019-04-08 00:00:00'),
(2, '201643502058', 'passwordnya2', 'operator', 'n', '2019-04-08 00:00:00');
...
INSERT INTO `tbl_order_customer` (`id_order_cust`, `kd_order`, `payment_type_id`, `detail_order_kd`, `meja_id`, `tanggal_transaksi`) VALUES
(1, 'ODR20190402001', 1, 'ODRD001040819', 1, '2019-04-08 00:00:00');
